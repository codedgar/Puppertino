...
Use this when you want to give users a manual toggle that overrides their system preference.
...
Consider supporting both auto and manual modes. Auto handles the common case. Manual lets users override.
...
The `.p-dark-mode` class and the dark mode manager have been part of Puppertino since v1. Existing projects continue to work without changes. The new v2 color tokens (text hierarchy, fills, materials) flip automatically when you upgrade.
