...
import buttons from '../../../data/components/buttons.js';
...
{buttons.variants.map((variant) => <VariantSection name={buttons.name} variant={variant} />)}
...
<Showcase
  name="buttons-colors"
  compact
  code={`<button class="p-button p-button-colored">Save</button>
...
<Showcase
  name="buttons-sizes"
  compact
  code={`<button class="p-button p-button-mini p-button-primary">Mini</button>
...
<Showcase
  name="buttons-icons"
  compact
  code={`<button class="p-button p-button-colored">
...
<button class="p-button p-button-destructive">
  ...
  snippet={`<!-- Icon font (Phosphor, Font Awesome, etc.) -->
...
<Showcase
  name="buttons-states"
  compact
  code={`<button class="p-button p-button-primary">Default</button>
