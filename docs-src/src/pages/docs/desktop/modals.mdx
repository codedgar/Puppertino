...
<Showcase
  name="modals-preview"
  snippet={false}
  code={`<div class="p-desktop-modal p-desktop-modal--stacked" style="position: relative; left: auto; top: auto; z-index: 0; opacity: 1; pointer-events: none; transform: none; width: 260px;" aria-hidden="true">
  <div class="p-desktop-modal__surface">
    <div class="p-desktop-modal__body">
...
<div class="p-desktop-modal p-desktop-modal--split" style="position: relative; left: auto; top: auto; z-index: 0; opacity: 1; pointer-events: none; transform: none; width: 260px;" aria-hidden="true">
  <div class="p-desktop-modal__surface">
    <div class="p-desktop-modal__body">
      <h2 class="p-desktop-modal__title">Save this message as a draft?</h2>
      <p class="p-desktop-modal__description">This message has not been sent and<br />contains unsaved changes. You can save<br />it as a draft to work on later.</p>
...
<Showcase
  name="modals-variants"
  snippet={false}
  compact
  code={`<button class="p-button p-button-primary" data-p-open-modal="#desktop-modal-stacked">Open stacked alert</button>
