...
<Showcase
  name="segmented-basic"
  compact
  code={`<div class="p-segmented" role="group" aria-label="Calendar view">
...
<div class="p-segmented" role="group" aria-label="Sort order">
  ...
  snippet={`<div class="p-segmented" role="group" aria-label="Calendar view">
...
<Showcase
  name="segmented-gray"
  compact
  code={`<div class="p-segmented p-segmented-gray" role="group" aria-label="Density">
...
<Showcase
  ...
  compact
  code={`<div class="p-segmented p-sys-purple" style="background: var(--p-fill-secondary);" role="group" aria-label="Purple example">
...
<Showcase
  ...
  snippet={false}
  compact
  code={`<div class="p-segmented" role="group" aria-label="Disabled example">
